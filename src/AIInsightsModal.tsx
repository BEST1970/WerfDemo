      ...
      <div className="flex-shrink-0 flex items-center justify-between px-6 py-4 border-b border-white/10 bg-black/40">
        <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-red-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-red-500/20">
                    <Network size={20} className="text-white" />
                </div>
                <div>
                    <h2 className="text-lg font-bold text-white leading-tight">Clash Analysis</h2>
                    <p className="text-xs font-medium text-slate-400">Schedule Overlap Force-Directed Graph</p>
                </div>
            </div>
        </div>
